module SpreeFlexiVariants
  class Engine < Rails::Engine
    ...
    initializer "spree.flexi_variants.assets.precompile" do |app|
        app.config.assets.precompile += ['store/spree_flexi_variants_exclusions.js','store/flexi-variants.*','store/spree-flexi-variants.*', 'jquery.validate/jquery.validate.min.js']
    end
